...
export const EnemyTables: Record<Terrain, EnemyTemplate[]> = {
  ...
  desert: [
    ...
    { name: 'Disciple', desc: 'You don\'t know what this person is mumbling, but it\'s definitely not poetry. Better to shut him up!', icon: 'assets/monsters/disciple.png', category: 'monster', terrains: ['desert'], minLevel: 2, maxLevel: 10 },  
    { name: 'Sand Worm', desc: 'The air trembles beneath your feet and you fall backward as you see a sandworm rising into the sky. Get up, you must fight for your life!', icon: 'assets/monsters/worm-sand.png', category: 'beast', terrains: ['desert'], minLevel: 2, maxLevel: 10 },  
  ],
  ...
  mountain: [
    ...
    { name: 'Skeleton', desc: 'Everything was so calm... But then a previously inert skeleton had to rise up and attack you!', icon: 'assets/monsters/skeleton.png', category: 'monster', terrains: ['mountain'], minLevel: 4, maxLevel: 8 },
  ...
  jungle: [
    ...
    { name: 'Giant Toad', desc: 'The size of this toad is impressive. You wonder if it would be able to swallow you. Better not to check...', icon: 'assets/monsters/toad.png', category: 'beast', terrains: ['swamp'], minLevel: 2, maxLevel: 10 },  
  ],
