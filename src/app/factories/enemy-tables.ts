...
export const EnemyTables: Record<Terrain, EnemyTemplate[]> = {
  plain: [
    ...
    { name: 'Skeleton', desc: 'Everything was so calm... But then a previously inert skeleton had to rise up and attack you!', icon: 'assets/monsters/skeleton-warrior.png', category: 'monster', terrains: ['plain'], minLevel: 4, maxLevel: 8 },
