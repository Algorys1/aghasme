...
1. A dark theme with a black background and a few gold runes (file assets/ui/dark_background.webp)
...
2. A parchment theme (file assets/ui/parchment_background.webp)
